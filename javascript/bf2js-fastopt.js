...
/** @constructor */
var $c_LCompiler$ = (function() {
  $c_O.call(this)
});
$c_LCompiler$.prototype = new $h_O();
$c_LCompiler$.prototype.constructor = $c_LCompiler$;
/** @constructor */
var $h_LCompiler$ = (function() {
  /*<skip>*/
});
$h_LCompiler$.prototype = $c_LCompiler$.prototype;
$c_LCompiler$.prototype.compile__T__T = (function(input) {
  if ((input === "")) {
    return input
  };
  var this$2 = new $c_sci_StringOps().init___T(input);
  var this$3 = $m_sci_List$();
  var cbf = this$3.ReusableCBFInstance$2;
  var jsx$2 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$2, cbf));
  var jsx$1 = new $c_LCompiler$$anonfun$compile$1().init___();
  var this$4 = $m_sci_List$();
  return (("(function brainfuck() {\nvar ptr = 0;\nvar prog = [0];\nfunction setByte() { if (prog[ptr] == null) prog[ptr] = 0; }\nfunction incPtr() { ptr++; setByte(); }\nfunction decPtr() { ptr--; setByte(); }\nfunction readInput() { var input = prompt('input'); if (input == null) return; else prog[ptr] = input.charCodeAt(0); }\nfunction printOutput() { alert(String.fromCharCode(prog[ptr])); }\n" + $as_sc_TraversableOnce(jsx$2.collect__s_PartialFunction__scg_CanBuildFrom__O(jsx$1, this$4.ReusableCBFInstance$2)).mkString__T__T("\n")) + "})();")
});
var $d_LCompiler$ = new $ClassTypeData({
  LCompiler$: 0
}, false, "Compiler$", {
  LCompiler$: 1,
  O: 1
});
$c_LCompiler$.prototype.$classData = $d_LCompiler$;
var $n_LCompiler$ = (void 0);
var $m_LCompiler$ = (function() {
  if ((!$n_LCompiler$)) {
    $n_LCompiler$ = new $c_LCompiler$().init___()
  };
  return $n_LCompiler$
});
/** @constructor */
...
var $s_s_PartialFunction$class__runWith__s_PartialFunction__F1__F1 = (function($$this, action) {
...
var $s_sc_TraversableLike$class__collect__sc_TraversableLike__s_PartialFunction__scg_CanBuildFrom__O = (function($$this, pf, bf) {
...
/** @constructor */
var $c_LBf2js$ = (function() {
  $c_O.call(this)
});
$c_LBf2js$.prototype = new $h_O();
$c_LBf2js$.prototype.constructor = $c_LBf2js$;
/** @constructor */
var $h_LBf2js$ = (function() {
  /*<skip>*/
});
$h_LBf2js$.prototype = $c_LBf2js$.prototype;
$c_LBf2js$.prototype.init___ = (function() {
  $n_LBf2js$ = this;
  return this
});
$c_LBf2js$.prototype.compile__V = (function() {
  var source = $objectToString((0, $g["jQuery"])("#source")["val"]());
  var program = $m_LCompiler$().compile__T__T(source);
  (0, $g["jQuery"])("#target")["val"](program)
});
$c_LBf2js$.prototype.addButton__T__F0__V = (function(text, func) {
  var target = $as_T($g["String"]["fromCharCode"](32));
  var replacement = $as_T($g["String"]["fromCharCode"](95));
  var id = $as_T(text["split"](target)["join"](replacement));
  var jsx$1 = (0, $g["jQuery"])("body");
  var s = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["<button id='", "'>", "</button>"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([id, text]));
  jsx$1["append"](s);
  (0, $g["jQuery"])(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["#", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([id])))["click"]((function(f) {
    return (function() {
      return f.apply__O()
    })
  })(func))
});
$c_LBf2js$.prototype.run__V = (function() {
  var x = $objectToString((0, $g["jQuery"])("#target")["val"]());
  $g["eval"](x)
});
$c_LBf2js$.prototype.main__V = (function() {
  (0, $g["jQuery"])("body")["append"]("<p>Brainfuck to JavaScript compiler</p>")["append"]("<textarea rows=20 cols=80 id='source' placeholder='source'/>")["append"]("<textarea rows=20 cols=80 id='target' placeholder='target'/>");
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("Hello world", new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    $m_LBf2js$().hello__V()
  }))), new $c_T2().init___O__O("Compile", new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    $m_LBf2js$().compile__V()
  }))), new $c_T2().init___O__O("Run", new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    $m_LBf2js$().run__V()
  }))), new $c_T2().init___O__O("Clear", new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    $m_LBf2js$().clear__V()
  })))]);
  var this$5 = $m_sci_List$();
  var cbf = this$5.ReusableCBFInstance$2;
  var this$7 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  var f = (function(x0$1$2) {
    var x0$1 = $as_T2(x0$1$2);
    if ((x0$1 !== null)) {
      var text = $as_T(x0$1.$$und1$f);
      var func = $as_F0(x0$1.$$und2$f);
      $m_LBf2js$().addButton__T__F0__V(text, func)
    } else {
...
$c_LBf2js$.prototype.hello__V = (function() {
  (0, $g["jQuery"])("#source")["val"]("++++++++[>++++[>++>+++>+++>+<<<<-]>+>+>->>+[<]<-]>>.>---.+++++++..+++.>>.<-.<.+++.------.--------.>>+.>++.")
});
$c_LBf2js$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LBf2js$.prototype.clear__V = (function() {
  (0, $g["jQuery"])("#source")["val"]("");
  (0, $g["jQuery"])("#target")["val"]("")
});
$c_LBf2js$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LBf2js$ = new $ClassTypeData({
  LBf2js$: 0
}, false, "Bf2js$", {
  LBf2js$: 1,
  O: 1,
...
$c_LBf2js$.prototype.$classData = $d_LBf2js$;
var $n_LBf2js$ = (void 0);
var $m_LBf2js$ = (function() {
  if ((!$n_LBf2js$)) {
    $n_LBf2js$ = new $c_LBf2js$().init___()
  };
  return $n_LBf2js$
});
$e["Bf2js"] = $m_LBf2js$;
...
/** @constructor */
var $c_LCompiler$$anonfun$compile$1 = (function() {
  $c_sr_AbstractPartialFunction.call(this)
});
$c_LCompiler$$anonfun$compile$1.prototype = new $h_sr_AbstractPartialFunction();
$c_LCompiler$$anonfun$compile$1.prototype.constructor = $c_LCompiler$$anonfun$compile$1;
/** @constructor */
var $h_LCompiler$$anonfun$compile$1 = (function() {
  /*<skip>*/
});
$h_LCompiler$$anonfun$compile$1.prototype = $c_LCompiler$$anonfun$compile$1.prototype;
$c_LCompiler$$anonfun$compile$1.prototype.applyOrElse__C__F1__O = (function(x1, default$2) {
  switch (x1) {
    case 43:
      {
        return "prog[ptr]++;";
    ...
    default:
      return default$2.apply__O__O(new $c_jl_Character().init___C(x1));
  }
});
$c_LCompiler$$anonfun$compile$1.prototype.isDefinedAt__O__Z = (function(x) {
  if ((x === null)) {
    var jsx$1 = 0
  } else {
  ...
  return this.isDefinedAt__C__Z(jsx$1)
});
$c_LCompiler$$anonfun$compile$1.prototype.applyOrElse__O__F1__O = (function(x, default$2) {
  if ((x === null)) {
    var jsx$1 = 0
  } else {
    var this$2 = $as_jl_Character(x);
  ...
  return this.applyOrElse__C__F1__O(jsx$1, default$2)
});
$c_LCompiler$$anonfun$compile$1.prototype.isDefinedAt__C__Z = (function(x1) {
  switch (x1) {
    case 43:
      {
        return true;
...
var $d_LCompiler$$anonfun$compile$1 = new $ClassTypeData({
  LCompiler$$anonfun$compile$1: 0
}, false, "Compiler$$anonfun$compile$1", {
  LCompiler$$anonfun$compile$1: 1,
...
$c_LCompiler$$anonfun$compile$1.prototype.$classData = $d_LCompiler$$anonfun$compile$1;
/** @constructor */
...
var $as_sc_AbstractIterable = (function(obj) {
...
var $asArrayOf_sc_AbstractIterable = (function(obj, depth) {
...
$c_sci_List.prototype.collect__s_PartialFunction__scg_CanBuildFrom__O = (function(pf, bf) {
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    ...
    return $s_sc_TraversableLike$class__collect__sc_TraversableLike__s_PartialFunction__scg_CanBuildFrom__O(this, pf, bf)
  }
});
...
//# sourceMappingURL=bf2js-fastopt.js.map
