...
(function(exports) {
  ...
  var mandelbrot = function (iterations) {
      return function (width) {
          return function (height) {
              return function (rect) {
                  var go = function (__copy_zr) {
                      return function (__copy_zi) {
                          return function (__copy_cr) {
                              return function (__copy_ci) {
                                  return function (__copy_n) {
                                      ...
                                      var n = __copy_n;
                                      tco: while (true) {
                                          var $2 = n > 0 && $$Math.sqrt(zr * zr + zi * zi) < 2.0;
                                          if ($2) {
                                              var zr$prime = (zr * zr - zi * zi) + cr;
                                              var zi$prime = zi * zr + zr * zi + ci;
                                              var __tco_cr = cr;
                                              var __tco_ci = ci;
                                              var __tco_n = n - 1;
                                              zr = zr$prime;
                                          ...
                                          throw new Error("Failed pattern match at Mandelbrot.Algorithm line 44, column 11 - line 48, column 16: " + [ $2.constructor.name ]);
                                      };
                                  };
                              };
                          };
                  ...
                  return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(height - 1))(function (v) {
                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(width - 1))(function (v1) {
                          ...
                          return [ Data_Int.toNumber(go(0.0)(0.0)(x$prime)(y$prime)(iterations)) / Data_Int.toNumber(iterations) ];
                      });
                  });
              };
          };
